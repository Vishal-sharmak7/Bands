...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: {img1}, text: 'seedhe maut' },
      { image: {img2}, text: 'seedhe maut' },
      { image: {img3}, text: 'seedhe maut' },
      { image: {img4}, text: 'seedhe maut' },
      { image: {img5}, text: 'seedhe maut' },
      { image: {img6}, text: 'seedhe maut' },
